<?php 
    if(!$error) { 
        ...
        $result = $statement->execute(array('id_tobacco' => $chooseTobaccoRating));
        ...
        // Schreibe Tabaksorte zu entsprechenden Hersteller
            if(isset($_POST['chooseTobaccoRating'])) {
                ...
                $result = $statement->execute(array('count' => $addRating, 'note' => $addNote,'id_tobacco' => $chooseTobaccoRating));
